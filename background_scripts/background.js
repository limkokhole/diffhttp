...
*/
    ...
    //    console.log("req is same tabId");
        notifyDevtools({"tabId":"diffHTTP_" + requestDetails.tabId, "tag":"add", "items":requestDetails});
...
function updateURL(responseDetails) {
    ...
    //    console.log("response is same tabId");
        notifyDevtools({"tabId":"diffHTTP_" + responseDetails.tabId, "tag":"update" ,"items":responseDetails});
    //} else console.log("response is NOT same tabId");
}

function logSentHeaders(e) {
    notifyDevtools({"tabId":"diffHTTP_" + e.tabId, "tag":"sentHeaders" ,"items":e});
}

function logReceivedHeaders(e) {
    notifyDevtools({"tabId":"diffHTTP_" + e.tabId, "tag":"recvHeaders" ,"items":e});
}
