  ...
  */
  ...
  if (prevPostData !== null) {
    ...
    if (prevPostData === postedString) {
      if (prevPostData === "") tdDiv.innerHTML = "<div style=\"border-bottom: 8px solid black; background-color:#00ffff;color:#000000;\"><b>[Same]</b>&nbsp;" + currTime + "</div>" + hole.diff_prettyHtml(humanDiffs);
      else tdDiv.innerHTML = "<div style=\"background-color:#00ffff;color:#000000;\"><b>[Same]</b>&nbsp;" + currTime + "</div>" + hole.diff_prettyHtml(humanDiffs);
    } else {
